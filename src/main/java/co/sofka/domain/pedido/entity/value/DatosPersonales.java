...
public class DatosPersonales implements ValueObject<DatosPersonales.Props> {
    ...
    //Comportamiento
    public DatosPersonales cambiarTelefono(String nuevoCelular){
        return new DatosPersonales(nombre,apellido,email,nuevoCelular);
    }
    public DatosPersonales actualizarEmail(String email){
        return new DatosPersonales(nombre, apellido,email,celular);
    }
